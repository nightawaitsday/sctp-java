...
public class FavouriteServiceImpl implements FavouriteService {
    ...
    //     Optional<Favourite> optionalFavourite = favouriteRepository.findByIdAndRestaurantId(id, restaurantId);
    //     Favourite favourite = optionalFavourite.orElseThrow(() -> new FavouriteNotFoundException(id, restaurantId));
